package by.brgtu.david.krasko.diplom.model;
...
public class Order {
    ...
    public Order(final Long orderId, final Status status, final String firstName, final String secondName) {
    ...
    public Order setSecondName(String secondName) {
        this.secondName = secondName;
        return this;
    }
